...
Current Phase (Week 1 – Experimental Design)
...
Task_08_Bias_Detection
prompts folder for prompt templates and hypotheses
results folder for raw LLM outputs
analysis folder for bias analysis scripts and visuals
experiment_design.docx as the main planning document
README.md for repository summary
...
Create final bias detection report by November 15, 2025.

Progress Report
Mandatory check-in due October 15, 2025
Submit your update through the Syracuse Qualtrics form link.
